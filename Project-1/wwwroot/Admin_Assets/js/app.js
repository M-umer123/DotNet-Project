...
// JavaScript localstorage tasks saved 
document.addEventListener("DOMContentLoaded", function () {
    ...
    // open/close sidebar
    function openSidebar() { taskSidebar.style.right = "0"; }
    function closeSidebar() {
        taskSidebar.style.right = "-380px";
    ...
    function loadTasks() {
        ...
        if (tasks.length === 0) {
            ...
            li.textContent = "No tasks yet. Click + Add to create one.";
        ...
        tasks.forEach((task, index) => {
            ...
            li.innerHTML = `
                ...
                <button class="btn btn-sm btn-danger delete-btn" title="Delete">✖</button>
            `;
